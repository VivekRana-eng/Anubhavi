...
def seed_demo_data():
    ...
    citizens = [
        ("RES-001", "Mohan Lal", 75, "Male", "+91 99145-88210", "H.No 125, Sector 3, Model Town", "Behind Main Market", 30.9032, 75.8590, "XXXX-XXXX-1102", "Diabetes Type 2, Reduced Mobility, Blood: B+ Positive", "HIGH", "LIVES_ALONE", station_id, (now - timedelta(hours=14)).strftime("%Y-%m-%d %H:%M"), "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&auto=format&fit=crop&q=80", "MISSED_CHECKIN"),
        ("RES-002", "Rajesh Sharma", 72, "Male", "+91 98102-33412", "H.No 412, Lane 4, Model Town Phase 2", "Near Guru Nanak Park", 30.9010, 75.8573, "XXXX-XXXX-4912", "Severe Cardiac History, Pacemaker Fitted (2023), Blood: O+ Positive", "HIGH", "LIVES_ALONE", station_id, (now - timedelta(hours=2)).strftime("%Y-%m-%d %H:%M"), "https://lh3.googleusercontent.com/aida-public/AB6AXuBat7vHn7EPcTZDqJ7rBrJuDdgA-FnLHTqp2a2PWOZ1WqsADGRMSx3KVckgN3anh5JkBJ8ywxMarf-TvyqGQiVvVUKpqr5lyqfLW_5T9RQcv3yzwQ75I0rrptSsmNgrn1x43heM4Yp-OlkO028N2LauSoBYrstyjrEYuuhG6_eUIiCSFYTnIgsdxoVVJiC-sL69UfoICnJfO4J11hBsDzNgrnGvA294LZTRRJAvxHkthKwX0Wrcf2nD", "SOS_ACTIVE"),
        ("RES-003", "Sunita Kapoor", 68, "Female", "+91 97812-33412", "H.No 88, Block C, Model Town", "Opp. Community Centre", 30.8995, 75.8560, "XXXX-XXXX-8821", "Hypertension, Arthritis, Blood: A+ Positive", "MEDIUM", "WITH_SPOUSE", station_id, (now - timedelta(hours=5)).strftime("%Y-%m-%d %H:%M"), "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&auto=format&fit=crop&q=80", "SAFE"),
        ("RES-004", "Harpreet Singh", 79, "Male", "+91 98881-22901", "H.No 204, Lane 2, Model Town", "Near Rose Garden", 30.9025, 75.8580, "XXXX-XXXX-7714", "Post-Stroke Recovery, Hypertension, Blood: O- Negative", "HIGH", "LIVES_ALONE", station_id, (now - timedelta(hours=8)).strftime("%Y-%m-%d %H:%M"), "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=150&auto=format&fit=crop&q=80", "SAFE"),
        ("RES-005", "Anita Verma", 70, "Female", "+91 96461-44912", "H.No 64, Phase 1, Model Town", "Near Post Office", 30.8980, 75.8540, "XXXX-XXXX-3390", "Asthma, Mild Cognitive Impairment, Blood: AB+ Positive", "MEDIUM", "LIVES_ALONE", station_id, (now - timedelta(hours=1)).strftime("%Y-%m-%d %H:%M"), "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80", "SAFE"),
        ("RES-006", "Ramesh Kumar", 77, "Male", "+91 98888-33210", "H.No 310, Sector 4, Model Town", "Near Community Park", 30.9110, 75.8510, "XXXX-XXXX-8123", "Mobility Limitation, Blood: B- Negative", "MEDIUM", "LIVES WITH FAMILY", station_id, (now - timedelta(hours=12)).strftime("%Y-%m-%d %H:%M"), "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&auto=format&fit=crop&q=80", "SAFE"),
